...
def run():
  pretest_data, _, _ = load_data_and_index('pretest.tsv')
  posttest_data, _, _ = load_data_and_index('posttest.tsv')
  print('pre-test averages')
  compute(pretest_data, QUESTIONS_INDEX, QUESTION_TEXT_INDEX)
